    ...
    <div className="mb-6">
        ...
        <div className={`bg-gradient-to-r ${getProjectionColor()} text-white rounded-2xl p-5 mb-5 shadow-xl animate-fade-in`}>
          <div className="flex items-center justify-between">
            ...
            <div className="text-right hidden md:block">
              <div className="text-4xl font-bold">{projection.estimatedDays}</div>
              <div className="text-sm opacity-90">gün kaldı</div>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-3xl p-8 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="text-center mt-4 text-xs text-gray-500">
                  🎯 Hedefine çok yakınsın! (Hedef: %{weeklyTarget})
                </div>
                <div className="text-center mt-4 text-xs text-purple-600 font-semibold animate-pulse">
                  👆 Tıkla detay gör
                </div>
          ...
          {/* KART 3: Çalışma Süresi - ✅ SORU İŞARETİ */}
          <div 
            className="relative h-64 cursor-pointer"
