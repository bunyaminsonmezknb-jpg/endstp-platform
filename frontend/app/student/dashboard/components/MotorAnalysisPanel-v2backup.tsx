...
/**
 * 4 MOTOR ANALİZ PANELİ - v2
 * 
 * Güncellemeler:
 * - BS-Model → "Akıllı Tekrar Planlayıcı"
 * - Her motor kartına açıklama eklendi
 */
...
export default function MotorAnalysisPanel() {
  ...
  // Demo data - gerçek test sonuçlarından analiz yapmak için
  ...
  const getSpeedColor = (ratio: number) => {
    if (ratio > 1.3) return 'text-red-600'; // Çok yavaş
    if (ratio > 1.1) return 'text-orange-600'; // Yavaş
    if (ratio >= 0.9) return 'text-green-600'; // Optimal
    return 'text-blue-600'; // Hızlı
  };
                ...
                <div key={topic.topic_id} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-purple-600">{topic.status}</div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border-2 border-blue-200">
                      ...
                      <div className="space-y-1 text-sm">
                        <div className="flex justify-between">
                          <span className="text-gray-600">Pace Ratio:</span>
